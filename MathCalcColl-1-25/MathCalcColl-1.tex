...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% Title & Author & Date %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{\Huge Подготовка к коллоквиуму 1}
        ...
        \item
            ...
            \begin{enumerate}
                \item
                    ...
                    то \( \exists \lim\limits_{x \to a-} f(x) = \sup\limits_{x \in E_a^-} f(x) \)
                \item
                    Если \( f \uparrow \) и ограничена снизу \( E_a^+ \),
                    а \( a \) --- предельная точка \( E_a^+ \),
                    то \( \exists \lim\limits_{x \to a+} f(x) = \inf\limits_{x \in E_a^+} f(x) \)
            \end{enumerate}
    \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \silentsection{Доказательства [не готово]}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{gather*}
        ...
        \sum\limits_{k = L}^{R} \frac{\cos \sqrt{k}}{\sqrt{k}}
            \geq \frac{1}{2} \cdot \frac{\frac{8 \pi^2 l}{3} - 1}{2 \pi l + \frac{\pi}{3}}
            \geq \frac{1}{2} \cdot \frac{\pi^2 l}{4 \pi l}
            = \frac{\pi}{8}
    \end{gather*}
    ...
    \silentsection{Листик 6 [не готово]} 
