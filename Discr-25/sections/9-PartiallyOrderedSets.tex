...
Но за счет плотности и отсутствия наибольшего (и наименьшего элемента) у нас найдется элемент из \( Q \),
...
\begin{enumerate}
    \item
        ...
        Ответ: \( n! \)
    \item
        Сколько есть цепей размера \( n + 1 \) в \( \BB^n \) проходят через \( \tilde{a} \) на уровне \( k \)?
