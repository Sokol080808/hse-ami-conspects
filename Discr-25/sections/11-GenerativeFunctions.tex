...
\begin{gather*}
    ...
    \\
    =
    -\sum\limits_{n=1}^{\infty} \dfrac{\frac{1}{2} \cdot \left( \frac{1}{2} - 1 \right) \cdot \ldots
    ...
    \\
    =
    \sum\limits_{n=1}^{\infty} \dfrac{2 \cdot 3 \cdot \ldots \cdot (2n - 3)}{2^n \cdot n!} 4^n x^n
    =
