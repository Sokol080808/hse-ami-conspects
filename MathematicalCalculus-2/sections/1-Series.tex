...
\begin{defn}{Основные понятия}{}
    ...
    \( S_n = \sum\limits_{k = 1}^{n} a_n \) --- частичные суммы.

    \( \sum\limits_{k = 1}^{\infty} a_k \) называется сходящимся,
    если сходится \( \{ S_n \}_{n = 1}^{\infty} \)
    и
    \( \sum\limits_{k = 1}^{\infty} a_k = \lim\limits_{n = 1}^{\infty} S_n \)
\end{defn}

\begin{example}{}{}
    \( \sum\limits_{n = 1}^{\infty} q^n \) сходится
    тогда и только тогда, когда \( |q| < 1 \).

    Сумма вычисляется по формуле \( \sum\limits_{n = 1}^{\infty} \frac{1}{1 - q} \).
\end{example}
...
\begin{assrt}{Критерий Коши}{}
    ...
    \(
        ...
        \forall n > N, \ p \in \NN \
        \left| \sum\limits_{k = n + 1}^{n + p} a_n \right| < \varepsilon
    \)
\end{assrt}
...
\begin{enumerate}
    \item
        Если \( \sum\limits_{n = 1}^{\infty} a_n \) и \( \sum\limits_{n = 1}^{\infty} \)
        сходятся, то
        \(
...
\[
    \left| \sum_{k = N + 1}^{N + p} a_k \right| \leq \left| \sum\limits_{k = N + 1}^{N + p} b_k \right|
\]
...
\begin{assrt}{Признак Коши}{}
    ...
    \begin{enumerate}
        \item
            Пусть \( \exists \delta > 0 \), что \( \sqrt[n]{a_n} \leq 1 - \delta \), начиная
...
\begin{enumerate}
    ...
    \item
        \( \sqrt[n]{a_n} \geq 1 \Rightarrow a_n > 1 \)
\qed
\end{enumerate}
...
\begin{example}{}{}
    ...
    \( \Leftrightarrow \)
    \( \int\limits_{1}^{\infty} \frac{1}{x^a} \) сходится,
    то есть при \( a > 1 \).
\end{example}
...
\begin{lemma}{}{}
    ...
    \( \Leftrightarrow \)
    \( \sup \left\{ \sum\limits_{n \in F} a_n : \underset{\text{конечно}}{F \subset N} \right\} < +\infty \)

    Более того,
    \(
        \sum\limits_{n = 1}^{\infty} a_n
        =
        \sup \left\{ \sum\limits_{n \in F} a_n : \underset{\text{конечно}}{F \subset N} \right\}
    \)
\end{lemma}
...
\begin{itemize}
    \item
        ...
        \( F \subset N \) --- конечное \( \Rightarrow \exists N : F \subset \{ 1, 2, \ldots, N \} \)
        \( \Rightarrow \)
        \(
...
\begin{itemize}
    ...
    \item
        ...
        Пусть \( \sum\limits_{m = 1}^{\infty} a_m = S < +\infty \)
        ...
        \[
            ...
            \varepsilon
            +
            \sum\limits_{m \in F_1 \cup \ldots \cup F_N}^{} a_n
            \leq
            \varepsilon
            +
            \sum\limits_{m = 1}^{\infty} a_m
...
\begin{enumerate}
    \item
        ...
        Потом, набираем наименьший индексы из \( J^- \) пока сумма не меньше \( s \):
        \[
...
\begin{itemize}
    ...
    \item
        ...
        \[
            c_{n + 1} - c_n = -_a{n + 1} + a_n + (b_{n + 1} - b_n)
            =
...
\begin{assrt}{}{}
    ...
    Если \( f_n \) непрерывно в \( x \) для любого \( n \)
    и равномерно сходится к \( f \) в некоторой окрестности \( x \),
    то \( \lim f_n = f \) непрерывно в \( x \).
\end{assrt}
...
Если \( f_n \to f \) равномерно сходится на шаре \( B_\gamma(x) \), то
\begin{gather*}
...
\begin{assrt}{}{}
    ...
    Тогда \( f \) интегрируемо по Риману и \( \int\limits_{a}^{b} f dx = \lim \int\limits_{a}^{b} f_n dx \)
\end{assrt}
