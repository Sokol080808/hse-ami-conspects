...
\begin{defn}{}{}
    ...
    \begin{enumerate}
        \item
            Если \( h(x) \to 1 \) при \( x \to a \), то \( f ~ g, x \to a \)
        \item
...
\begin{example}{}{}
    \( f ~ g, x \to a \Leftrightarrow f - g = o(f), f - g = o(g), x \to a \)
\end{example}
...
\begin{thrm}{Теорема Вейерштрасса}{}
    Пусть \( f \) монотонна на \( E \) и ограничена на \( E \).

    Тогда если \( a \) --- предельная точка \( E_a^+ \), то \( \exists \lim\limits_{x \to a+} f(x) \)
\end{thrm}

Доказательство:

Пусть \( f \uparrow \). 
Тогда \( \{ f(x) \} \) ограниченно снизу на \( E_a^+ \).
